                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><button class="table-sort" data-sort="sort-tlp">Telpon</button></th>
                                    <th><button class="table-sort" data-sort="sort-rtrw">RT/RW</button></th>
                                    <th><button class="table-sort" data-sort="sort-ket_pengaduan">Pengaduan</button>
                                    </th>
                                </tr>
                            </thead>
                            <tbody class="table-tbody list">
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td class="sort-alamat">{{ $data->alamat }}</td>
                                        <td class="sort-tlp">{{ $data->tlp }}</td>
                                        <td class="sort-rtrw">{{ $data->rtrw }}</td>
                                        <td class="sort-ket_pengaduan">{{ $data->ket_pengaduan }}</td>
                                    </tr>
                                @endforeach
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const list = new List('table-default', {
                ...
                valueNames: ['sort-nama', 'sort-no_kk', 'sort-alamat', 'sort-tlp']
            });
        })
    </script>
@endpush
