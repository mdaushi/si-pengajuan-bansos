<ul class="navbar-nav pt-lg-3">
    ...
    @can('admin')
        <li class="nav-item {{ Request::is('dashboard/admin/pengajuan') ? 'active' : '' }}">
            <a class="nav-link" href="{{ url('dashboard/admin/pengajuan') }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-forms" width="24"
                        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
        ...
        <li class="nav-item {{ Request::is('dashboard/admin/penerima') ? 'active' : '' }}">
            <a class="nav-link" href="{{ url('dashboard/admin/penerima') }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-status-change"
                        width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
        ...
        <li class="nav-item {{ Request::is('dashboard/admin/tertolak') ? 'active' : '' }}">
            <a class="nav-link" href="{{ url('dashboard/admin/tertolak') }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24"
                        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
        ...
        <li class="nav-item {{ Request::is('dashboard/admin/kriteria') ? 'active' : '' }}">
            <a class="nav-link" href="{{ url('dashboard/admin/kriteria') }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-square-minus"
                        width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
        ...
        <li class="nav-item {{ Request::is('dashboard/admin/pengaduan') ? 'active' : '' }}">
            <a class="nav-link" href="{{ url('dashboard/admin/pengaduan') }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block">
                    <!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-forms" width="24"
                        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
